...
import reservationsystem.SigninFrame;
import util.DbConn;

public class AdminSigninFrame extends JFrame{

	public static String email;
	public AdminSigninFrame() {
	...
	public void checkSignIn(String name, String userid, String password, String mn, String em) {
		...
		String sql = "insert into users (user_name, user_id, password, mobile_number, email, user_type) values (?, ?, ?, ?, ?, 'admin')";
